...
<table border="1">
  ...
  <tr>
    <td>HistoryMapper.insertHistoryMovie(int historyId, String movieName,int ticketId)</td>
...
<tr>
  ...
  <tr>
    <td>VipStrategyMapper.selectAllStrategy()</td>
...
<table border="1">
  ...
  <tr>
    ...
    <td colspan="2"> <center>根据couponId和userId向数据库中插入新的可使用的优惠券记录</center></td>
  </tr>
